...
// In Production: Uses VITE_API_URL or defaults to live backend on Render (https://eloquence2k26-3npu.onrender.com)
...
const resolvedApiUrl = rawEnvUrl 
  ? rawEnvUrl 
  : (isLocalhost ? '' : 'https://eloquence2k26-3npu.onrender.com');
